...
import numpy as np
from dataloader.load_data_UTKFace import *
import warnings
...
def _data_loader(args):
    ...
    # Real Data (UTKFace)
    train_data = Dataloader_UTKFace_Real(
        mode="train",
        dataset_path=args.real_data_path,
        img_size=args.image_size
    )

    test_data = Dataloader_UTKFace_Real(
        mode="test",
        dataset_path=args.real_data_path,
        img_size=args.image_size
    )
    ...
    # TEMPORARY (same loader for all)
    return train_loader, train_loader, train_loader, test_loader, test_loader
