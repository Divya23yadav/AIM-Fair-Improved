...
class Dataloader_UTKFace_Real(Dataset):
    ...
    # append ONLY after validation
          ...
          self.labels_target.append(gender)

          if race == 0:
             self.labels_sensitive.append(1)
          else:
             self.labels_sensitive.append(0)

#  DEBUG PRINT HERE
        print("Images:", len(self.images))
        print("Target labels:", len(self.labels_target))
        print("Sensitive labels:", len(self.labels_sensitive))
...
class Dataloader_UTKFace_RealAndSynthetic(Dataset):
    ...
    # ONLY append after everything is correct
            self.images.append(filename)
            self.labels_target.append(gender)
